// Scope reference catalog (Google Workspace + Microsoft Graph permission names).
// Source: restored from scopes-seed.ts (authored earlier), retained as audit context.
...
export type { ScopeDef, ThemeKeywordMap };
export { GOOGLE_WORKSPACE_SCOPES, MS_GRAPH_SCOPES, CATEGORY_THEME_MAP };
